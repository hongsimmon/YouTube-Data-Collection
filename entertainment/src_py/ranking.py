...
BASE_DIR = os.path.expanduser('~/YouTube/entertainment')
...
async def main():
    url = 'https://us.youtubers.me/united-states/entertainment/top-1000-most-subscribed-youtube-channels-in-united-states'
