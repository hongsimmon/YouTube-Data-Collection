...
BASE_DIR = os.path.expanduser('~/YouTube/blogs')
...
async def main():
    url = 'https://us.youtubers.me/united-states/people-blogs/top-1000-most-subscribed-youtube-channels-in-united-states'
