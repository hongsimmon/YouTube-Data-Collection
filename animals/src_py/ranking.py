...
BASE_DIR = os.path.expanduser('~/YouTube/animals')
...
async def main():
    url = 'https://us.youtubers.me/united-states/pets-animals/top-1000-most-subscribed-youtube-channels-in-united-states'
